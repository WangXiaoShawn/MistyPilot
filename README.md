...
> 📄 **Paper**: [MistyPilot: An Agentic Fast–Slow Thinking LLM Framework for Misty Social Robots](https://arxiv.org/pdf/2603.03640)
...
| `use_local_audio` | `true` to play local MP3 emotion sound effects, `false` to skip |
