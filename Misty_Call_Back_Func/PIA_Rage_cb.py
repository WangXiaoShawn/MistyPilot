...
def rage(misty_ip: str, api_key: Optional[str] = None) -> None:
    ...
    json_path = os.path.join(current_dir, "P2_Speaking_JSON", "rage.json")
...
def cb_rage(evt: Dict[str, Any],misty_ip: str, api_key: Optional[str] = None) -> None:
    """
    Trigger Misty to express 'rage' or anger.
    Call this for any user request related to showing anger, frustration, or rage
    """
