...
def happy(misty_ip: str, api_key: Optional[str] = None) -> None:
    ...
    json_path = os.path.join(current_dir, "P2_Speaking_JSON", "happy.json")
...
def cb_happy(evt: Dict[str, Any],misty_ip: str, api_key: Optional[str] = None) -> None:
    """
    Trigger Misty to express 'happy' or pleasure.
    Call this for any user request related to showing joy, happiness, or pleasure
    """
