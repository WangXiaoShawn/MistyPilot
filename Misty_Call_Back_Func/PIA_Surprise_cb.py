...
def surprise(misty_ip: str, api_key: Optional[str] = None) -> None:
    ...
    json_path = os.path.join(current_dir, "P2_Speaking_JSON", "surprise.json")
...
def cb_surprise(evt: Dict[str, Any],misty_ip: str, api_key: Optional[str] = None) -> None:
    """
    Trigger Misty to express 'surprise' or surprise.
    Call this for any user request related to showing surprise,惊讶, or surprise
    """
