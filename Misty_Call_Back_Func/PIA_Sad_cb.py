...
def sad(misty_ip: str, api_key: Optional[str] = None) -> None:
    ...
    json_path = os.path.join(current_dir, "P2_Speaking_JSON", "sadness.json")
...
def cb_sad(evt: Dict[str, Any],misty_ip: str, api_key: Optional[str] = None) -> None:
    """
    Trigger Misty to express 'sad' or sadness.
    Call this for any user request related to showing sadness, grief, or unhappiness
    """
